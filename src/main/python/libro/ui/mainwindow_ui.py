...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.navList.setFrameShape(QtWidgets.QFrame.StyledPanel)
        ...
        self.infoSplitter = QtWidgets.QSplitter(self.frame)
        self.infoSplitter.setOrientation(QtCore.Qt.Horizontal)
        self.infoSplitter.setObjectName("infoSplitter")
        self.bookTable = BookTableView(self.infoSplitter)
        self.bookTable.setFrameShape(QtWidgets.QFrame.StyledPanel)
        ...
        self.scrollArea = QtWidgets.QScrollArea(self.infoSplitter)
        self.scrollArea.setMinimumSize(QtCore.QSize(250, 0))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 292, 465))
        ...
        self.cover.setMinimumSize(QtCore.QSize(120, 160))
        font = QtGui.QFont()
        ...
        self.translator = QtWidgets.QLabel(self.scrollAreaWidgetContents)
        self.translator.setObjectName("translator")
        self.verticalLayout_2.addWidget(self.translator)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.cover.setText(_translate("MainWindow", "No cover"))
        self.author.setText(_translate("MainWindow", "Айзек Азимов"))
        self.title.setText(_translate("MainWindow", "Роботы и империя"))
        self.series.setText(_translate("MainWindow", "<b>Серия:</b> Роботы и империя (1)"))
        self.tags.setText(_translate("MainWindow", "<b>Теги:</b> фантастика"))
        self.lang.setText(_translate("MainWindow", "<b>Язык:</b> ru"))
        self.translator.setText(_translate("MainWindow", "<b>Перевод:</b> Иванов И. И."))
